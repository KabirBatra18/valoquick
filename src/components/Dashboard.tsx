        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex-shrink-0">
              <h1 className="text-lg sm:text-xl font-bold text-text-primary">ValuQuick</h1>
              <p className="text-[10px] sm:text-xs text-text-tertiary truncate max-w-[100px] sm:max-w-none">{firm?.name || 'Valuation Reports'}</p>
            </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-3">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 bg-surface-100 rounded-lg sm:rounded-xl border border-surface-200">
                {user?.photoURL ? (
                  ...
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-brand flex items-center justify-center text-white text-[10px] sm:text-xs font-medium flex-shrink-0">
                ...
                <button
                  ...
                  title="Sign out"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button
                ...
                disabled={isCreating}
                className="flex items-center justify-center gap-1.5 sm:gap-2 p-2 sm:px-4 sm:py-2.5 bg-brand text-white rounded-lg sm:rounded-xl font-medium text-sm hover:bg-brand-dark transition-colors shadow-lg shadow-brand/25 disabled:opacity-50"
              >
                {isCreating ? (
